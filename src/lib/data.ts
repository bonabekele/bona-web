...
export const education = [
  {
    ...
    startDate: '2021',
    endDate: '2025',
    description: 'Studyin in BME as my major and also doing my Thesis on CNN image classification to solve health issues. Thesis on "Liver Image Classification with CNN." GPA: 3.55/4.0',
  },
  {
    id: '2',
...
export const projects: Project[] = [
  {
    ...
    githubUrl: 'https://github.com/bonabekele',
    demoUrl: 'https://demo.com',
    technologies: ['CNN', 'TensorFlow.js', 'FastAPI', 'Next.js'],
    featured: true,
  },
  {
    id: '2',
  ...
  },
  {
    id: '6',
    title: 'Medtech',
    description: 'A modern, responsive portfolio website template designed for medical devices maintenance and schedule.',
    shortDescription: 'Modern portfolio website template for creatives',
    category: 'Web Development',
    image: '/ui-3.png',
    githubUrl: 'https://github.com/bonabekele',
    demoUrl: 'https://demo.com',
    technologies: ['Typescript', 'Tailwind', 'Nextjs', 'Node.js'],
    featured: false,
  },
];
